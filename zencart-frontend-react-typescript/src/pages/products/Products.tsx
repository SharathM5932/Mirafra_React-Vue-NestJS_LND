...
const Products = () => {
  ...
  // Making the GET req. for product and category
  const [
        ...
        {isProductsLoading ? (
          ...
          <div className="product_card_container">
            {products?.data?.products?.length === 0 ? (
              ...
              >
                <MdSearchOff size={28} style={{ color: "#888" }} />
                <span>
                  No products found for the selected filters. Please try a
                  different category or sorting option.
                </span>
              </motion.div>
            ) : (
