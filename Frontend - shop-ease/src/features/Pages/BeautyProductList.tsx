...
import { useWishlist } from '../wishlist/wishlistContext'; // ✅ Wishlist context
...
const BeautyProductList: React.FC = () => {
  ...
  const beautyProducts = products
    .filter((product) => product.cat?.toLowerCase() === 'beauty')
      ...
      <div className="women-products">
        ...
        <div className="cart-grid">
          {beautyProducts.length > 0 ? (
            ...
            <p>No beauty products found matching your criteria.</p>
          )}
        </div>
      </div>
      <Footer />
